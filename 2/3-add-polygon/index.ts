...
polygon  } from "leaflet";
  ...
  */
  ...
  map.fitBounds([
      [polygonItem.getBounds().getNorthEast().lat, polygonItem.getBounds().getNorthEast().lng],
      [polygonItem.getBounds().getNorthWest().lat, polygonItem.getBounds().getNorthWest().lng],
      [polygonItem.getBounds().getSouthEast().lat, polygonItem.getBounds().getSouthEast().lng],
