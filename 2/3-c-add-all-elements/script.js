...
// Añadir dos polylines, haciendo una cruz


const polyLineOneLocationsPoint = [
  [43.175663, -2.412301],
  [43.172156, -2.413997]
];

const polyLineOne = L.polyline(polyLineOneLocationsPoint, {color: 'green', weight: 7, }).addTo(map);

const polyLineTwoLocationsPoint = [
  [43.174922, -2.417513],
  [43.173352, -2.409870]
];

const polyLineTwo = L.polyline(polyLineTwoLocationsPoint, {color: 'green', weight: 7, }).addTo(map);
